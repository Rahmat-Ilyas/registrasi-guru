                                ...
                                <div class="row m-0">
                                    <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                                        <span class="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
                                            <!--begin::Svg Icon | path:{{ asset('assets/media/svg/icons/Media/Equalizer.svg') }}-->
                                ...
                                <div class="row m-0">
                                    ...
                                    <div class="col bg-light-success px-6 py-8 rounded-xl">
                                        <span class="svg-icon svg-icon-3x svg-icon-success d-block my-2">
                                            <!--begin::Svg Icon | path:{{ asset('assets/media/svg/icons/Communication/Urgent-mail.svg') }}-->
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <span class="symbol symbol-50 symbol-light-primary mr-2">
                                    <span class="symbol-label">
                                        <span class="svg-icon svg-icon-xl svg-icon-primary">
                                            <!--begin::Svg Icon | path:{{ asset('assets/media/svg/icons/Communication/Group.svg') }}-->
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <div class="col-lg-6 col-xxl-4 order-1 order-xxl-1">
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label font-weight-bolder text-dark">Tasks
                                    Overview</span>
                                <span class="text-muted mt-3 font-weight-bold font-size-sm">Pending 10
                                    tasks</span>
                            </h3>
                            <div class="card-toolbar">
                                ...
                                <div class="symbol symbol-40 symbol-light-info mr-5">
                                    <span class="symbol-label">
                                        <span class="svg-icon svg-icon-lg svg-icon-info">
                                            <!--begin::Svg Icon | path:{{ asset('assets/media/svg/icons/Communication/Shield-user.svg') }}-->
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-body pt-2">
                            ...
                            <div class="d-flex align-items-center mb-10">
                                ...
                                <div class="symbol symbol-40 symbol-light-success mr-5">
                                    <span class="symbol-label">
                                        <img src="{{ asset('assets/media/svg/avatars/006-girl-3.svg') }}"
                                            class="h-75 align-self-end" alt="" />
                                    </span>
                                </div>
                                <!--end::Symbol-->
                            ...
                            <div class="d-flex align-items-center mb-10">
                                ...
                                <div class="symbol symbol-40 symbol-light-success mr-5">
                                    <span class="symbol-label">
                                        <img src="{{ asset('assets/media/svg/avatars/015-boy-6.svg') }}"
                                            class="h-75 align-self-end" alt="" />
                                    </span>
                                </div>
                                <!--end::Symbol-->
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="symbol symbol-40 symbol-light-success mr-5">
                                    <span class="symbol-label">
                                        <img src="{{ asset('assets/media/svg/avatars/016-boy-7.svg') }}"
                                            class="h-75 align-self-end" alt="" />
                                    </span>
                                </div>
                                <!--end::Symbol-->
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10">
                                ...
                                <!--end::Section-->
                                <!--begin::Desc-->
                                <p class="text-dark-50 m-0 pt-5 font-weight-normal">A brief write up
                                    about the top Authors that fits within this section</p>
                                <!--end::Desc-->
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="mb-10">
                                ...
                                <!--begin::Desc-->
                                <p class="text-dark-50 m-0 pt-5 font-weight-normal">A brief write up
                                    about the Popular Authors that fits within this section</p>
                                <!--end::Desc-->
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="">
                                ...
                                <!--begin::Desc-->
                                <p class="text-dark-50 m-0 pt-5 font-weight-normal">A brief write up
                                    about the New Users that fits within this section</p>
                                <!--end::Desc-->
                            </div>
                            <!--end::Item-->
                        </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="pt-5">
                                <p class="text-center font-weight-normal font-size-lg pb-7">Notes:
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="text-muted font-weight-bold">Web,
                                                        UI/UX Design</span>
                                                </td>
                                                <td>
                                                    <img src="{{ asset('assets/media/logos/stars.png') }}" alt="image"
                                                        style="width: 5.5rem" />
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="text-muted font-weight-bold">Houses
                                                        &amp; Hotels</span>
                                                </td>
                                                <td>
                                                    <img src="{{ asset('assets/media/logos/stars.png') }}" alt="image"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ asset('assets/media/logos/stars.png') }}"
